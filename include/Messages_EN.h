...
#define MESSAGES_FANS         "      Fans      "
#define MESSAGES_DISCONNECTED "  disconnected  "
#define MESSAGES_FAN_NUMBER   "     Fan %1d      "
#define MESSAGES_FAN_SAVED    "  saved (%3d%%)  "
#define MESSAGES_FAN_INFO     "%4d RPM  (%3d%%)"